...
/**
 * Java 3 Assignment 1
 * A Java Class to run the application. Perform Create, Read, Update, and Delete operations in the database.
...
public class BookApplication {
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            // If null: callback configuration file
            ...
            while (running) {
                ...
                if (choice == 1) {
                    ...
                    editBookOrAuthor(scanner, dbManager);
                } else if (choice == 4) {
                    addNewBook(scanner, dbManager);
                } else if (choice == 5) {
                    running = false;
                } else {
    ...
    private static void editBookOrAuthor(Scanner scanner, BookDatabaseManager dbManager) {
        System.out.println("Edit a book or an author? (Enter 'book' or 'author'):");
        ...
        try {
            if ("book".equals(choice)) {
                ...
                System.out.println("Enter the full name of the author to edit:");
    ...
    private static void addNewBook(Scanner scanner, BookDatabaseManager dbManager) {
        try {
            ...
            System.out.println("Enter the ISBN of the new book(10 digit number):");
            String isbn = scanner.nextLine();

            System.out.println("Enter the edition number(number):");
            int editionNumber = scanner.nextInt();
            scanner.nextLine();

            System.out.println("Enter the copyright information(year):");
